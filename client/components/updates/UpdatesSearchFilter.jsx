...
import { UPDATE_CATEGORIES, UPDATE_SORT_OPTIONS } from "@/data/updates";

export default function UpdatesSearchFilter({
  search,
  onSearchChange,
  activeCategory,
  onCategoryChange,
  ...
  return (
    <div
      id="updates-feed"
      className="sticky top-20 z-30 scroll-mt-24 space-y-4 rounded-2xl border border-slate-200/90 bg-white/95 p-4 shadow-lg shadow-slate-900/5 backdrop-blur-sm sm:p-5"
    >
