...
export default function EmptyState({ title, subtitle, onOpenFilters }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white/90 px-6 py-16 text-center shadow-sm">
      <div className="mb-4 grid h-14 w-14 place-items-center rounded-2xl bg-slate-50 ring-1 ring-slate-200">
        <GraduationCap className="h-7 w-7 text-slate-400" aria-hidden />
      </div>
